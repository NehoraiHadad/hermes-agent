...
def test_triggered_turn_uses_same_shared_group_source_and_immediate_context():
    ...
    trigger = _group_message(
        ...
        # Multi-device bot id must normalize to the same principal as the
        # clean mentioned id (selective port of #85503).
        botIds=["15551230000:17@s.whatsapp.net"],
    )
...
def test_immediate_context_window_remains_bounded_to_fifty_messages():
    ...
    # Durable storage is one row per message, independent of the ring bound.
